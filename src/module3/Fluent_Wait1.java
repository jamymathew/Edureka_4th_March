...
public class Fluent_Wait1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * There is the same Fluent wait example but here I am trying to explain the
		 * execution by displaying in the console by using the print output so that the
		 * user can see how many times the check on an element is done before it could
